        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title d-inline">Manajemen User</h4>
...
<div class="modal fade" id="modal">
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url('administrator/manajemen_user' . '_save'); ?>" method="post" enctype="multipart/form-data" id="form-data" onsubmit="return false">
...
<script>
    var table = $('table').DataTable({
        'ajax': {
            'url': '<?php echo base_url('administrator/manajemen_user' . '_fetch') ?>',
            'dataSrc': 'data',
            'type': 'POST'
        },
        'processing': true,
    ...
    function dt_del(t) {
        Swal.fire({
            ...
            if (result.value) {
                $.LoadingOverlay('show');
                $.post('<?= base_url('administrator/manajemen_user' . '_del') ?>', {
