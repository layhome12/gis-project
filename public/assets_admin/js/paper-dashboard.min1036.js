  ...
  (paperDashboard = {
    ...
    initMinimizeSidebar: function () {
      $("#minimizeSidebar").click(function () {
        $(this);
        1 == paperDashboard.misc.sidebar_mini_active
          ? ($("body").removeClass("sidebar-mini"),
            (paperDashboard.misc.sidebar_mini_active = !1))
          : ($("body").addClass("sidebar-mini"),
            (paperDashboard.misc.sidebar_mini_active = !0));
    ...
    showSidebarMessage: function (a) {
      try {
        $.notify(
          { icon: "nc-icon nc-bell-55", message: a },
          {
            type: "info",
            timer: 4e3,
